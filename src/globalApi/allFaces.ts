...
import type { WithFaceDescriptor, WithFaceDetection, WithFaceLandmarks } from '../factories';
import { type IMtcnnOptions, MtcnnOptions } from '../mtcnn/MtcnnOptions';
...
): Promise<WithFaceDescriptor<WithFaceLandmarks<WithFaceDetection<object>>>[]> {
  console.warn(
