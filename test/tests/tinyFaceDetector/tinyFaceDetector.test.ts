...
describeWithBackend('tinyFaceDetector', () => {
  ...
  describeWithNets(
    'tinyFaceDetector',
    { withAllFacesTinyFaceDetector: true, withFaceExpressionNet: { quantized: true } },
    () => {
      describe('detectAllFaces', () => {
        ...
        it('detectAllFaces.withFaceLandmarks()', async () => {
          ...
          const results = await faceapi.detectAllFaces(imgEl, options).withFaceLandmarks();
      ...
      describe('detectSingleFace', () => {
        ...
        it('detectSingleFace.withFaceLandmarks()', async () => {
          ...
          const result = await faceapi.detectSingleFace(imgEl, options).withFaceLandmarks();
