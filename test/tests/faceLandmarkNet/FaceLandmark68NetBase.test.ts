...
class FakeFaceLandmark68NetBase extends FaceLandmark68NetBase<any> {
  ...
  public runNet(): any {
    throw new Error('FakeFaceLandmark68NetBase - runNet not implemented');
  }
}
  ...
  describe('postProcess', () => {
    ...
    describe('single batch', () => {
      it('transform x coordinates for width < height', () => {
        ...
        const out = net
          .postProcess(tf.tensor2d(landmarksData, [1, 136]), 128, [{ width: 200, height: 300 }])
          .dataSync();
      ...
      it('transform y coordinates for height < width', () => {
        ...
        const out = net
          .postProcess(tf.tensor2d(landmarksData, [1, 136]), 128, [{ width: 300, height: 200 }])
          .dataSync();
      ...
      it('no transformation for height === width', () => {
        ...
        const out = net
          .postProcess(tf.tensor2d(landmarksData, [1, 136]), 128, [{ width: 300, height: 300 }])
          .dataSync();
