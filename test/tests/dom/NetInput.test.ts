...
describe('NetInput', () => {
  ...
  describe('toBatchTensor', () => {
    it('HTMLImageElement, batchSize === 1', () =>
      tf.tidy(() => {
    ...
    it('HTMLImageElements, batchSize === 4', () =>
      tf.tidy(() => {
    ...
    it('tf.Tensor3Ds and HTMLImageElements, batchSize === 4', () =>
      tf.tidy(() => {
        const tensor = tf.zeros<tf.Rank.R3>([200, 200, 3], 'int32');
